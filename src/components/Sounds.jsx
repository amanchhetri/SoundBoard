...
function Sounds() {
  ...
  const animations = ["animate-left", "animate-up", "animate-right", "animate-down", "animate-size"];
  ...
  return (
    <div
      ...
      className={animate ? `${animations[Math.floor(Math.random() * animations.length)]} container` : "container"}
    >
